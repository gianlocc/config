...
Vendored from https://github.com/sahaj-b/ghostty-cursor-shaders at commit 06d4e90.
Copied in rather than used as a submodule so a plain `git clone` is enough.
